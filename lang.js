...
var tutorial3ESP = "Los hechizos se dibujan en el grimorio, que es donde deberás realizar tus cortes. Puede encontrarse en dos estados:\n"+
...
initialSetup = function () {
    $('#tutorial1').html(title1ENG);
    $('#tutorial2').html(title2ENG);
    $('#tutorial3').html(title3ENG);
    $('#description1').html(tutorial1ENG);
    $('#description2').html(tutorial2ENG);
    $('#description3').html(tutorial3ENG);
}
/*TODO
